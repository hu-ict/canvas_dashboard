...
if __name__ == "__main__":
    ...
    print(f"RUN27 - Time running: {minutes}:{seconds:02d} (m:ss)")
    print("RUN28 - Time running:", total_seconds, "seconds")
    print("RUN29 - Date running:", get_actual_date())
