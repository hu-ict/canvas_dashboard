...
class Assignment:
    def __init__(self, id, name, group_id, course_section_id, points, assignment_date, unlock_date, assignment_day):
        self.id = id
        self.name = name
    ...
    def __str__(self):
        return f'Assignment({self.id}, {self.name}, {self.group_id}, {self.section_id}, {self.points}, {get_date_time_str(self.assignment_date)}, {self.assignment_day})'
