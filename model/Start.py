...
class Start:
    ...
    def __str__(self):
        return f'Start({self.canvas_course_id}, {self.project_group_name},  {self.guild_group_name},  {self.start_date}, {self.end_date}, {self.api_key})\n'

    def to_json(self, scope):
        dict_result = {
            'api_key': self.api_key,
            'canvas_course_id': self.canvas_course_id,
            'project_group_name': self.project_group_name,
            'guild_group_name': self.guild_group_name,
    ...
    def from_dict(data_dict):
        if 'project_group_name' in data_dict:
            project_group_name = data_dict['project_group_name']
        else:
            project_group_name = data_dict['projects_groep_name']
        if 'guild_group_name' in data_dict:
            guild_group_name = data_dict['guild_group_name']
        else:
            guild_group_name = ""
