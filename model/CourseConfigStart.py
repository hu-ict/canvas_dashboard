...
class CourseConfigStart:
    def __init__(self, course_id, projects_groep_name, peil_perspective, start_date, end_date, config_file_name, course_file_name, results_file_name, api_key):
    ...
    def __str__(self):
        return f'CourseConfigStart({self.course_id}, {self.projects_groep_name}, {self.peil_perspective},  {self.start_date}, {self.end_date}, {self.config_file_name}, {self.course_file_name}, {self.results_file_name}, {self.api_key})\n'

    @staticmethod
    def from_dict(data_dict):
        new_course_config_start = CourseConfigStart(data_dict['course_id'], data_dict['projects_groep_name'],
