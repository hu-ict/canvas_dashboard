...
def get_assignment_group_release_planning(instance, assignment_group, templates):
    ...
    file_name_levels = "level_serie_" + str(assignment_group.levels) + ".html"
    file_name_release_planning = "release_planning_" + str(assignment_group.id) + ".html"
    link_path_name_levels = instance.get_link_general_path() + file_name_levels
    link_path_name_release_planning = instance.get_link_general_path() + file_name_release_planning
    # print("BBS31 -", file_name_group)

    return templates["release_planning_perspective"].substitute(
        {'url_levels': link_path_name_levels,
         'url_group': link_path_name_release_planning,
