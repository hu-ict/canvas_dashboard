...
def build_bootstrap_learning_outcome_tab(instance, course, templates, a_level_serie_collection):
    ...
    for learning_outcome in course.learning_outcomes:
        file_name = "learning_outcome_" + str(learning_outcome.id).lower() + ".html"
        link_path_name = instance.get_link_general_path() + file_name
        ...
        write_learning_outcome_index(course, templates, learning_outcome, instance.get_html_general_path()+file_name)
