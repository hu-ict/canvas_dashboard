...
from scripts.lib.build_bootstrap_structure import build_bootstrap_analytics_tab, build_learning_analytics, \
    build_bootstrap_release_planning_tab, build_bootstrap_analyse_tab
from scripts.lib.build_bootstrap_werkvoorraad import build_bootstrap_teacher_tab
...
def build_bootstrap_menu(a_instance, a_templates, a_menu_items):
    start_pages = {"Groepen": a_instance.get_link_general_path() + "standard.html",
                   "Gilden": a_instance.get_link_general_path() + "standard.html",
                   "Rollen": a_instance.get_link_general_path() + "standard.html",
                   "Voortgang": a_instance.get_link_general_path() + "totals_voortgang.html",
                   "Werkvoorraad": a_instance.get_link_general_path() + "workload_index.html",
                   "Release Planning": a_instance.get_link_general_path() + "overall_opbouw.html",
                   "Leeruitkomsten": a_instance.get_link_general_path() + "standard.html",
                   "Analytics": a_instance.get_link_general_path() + "standard.html",
                   "Analyse": a_instance.get_link_general_path() + "standard.html"}
    html_menu_string = ""
