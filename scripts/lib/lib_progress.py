from scripts.lib.lib_attendance import get_attendance_progress
from scripts.model.ProgressDay import ProgressDay
from scripts.model.perspective.Status import MISSED_ITEM
