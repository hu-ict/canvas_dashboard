import json
import sys
from scripts.lib.file import read_course, read_course_instances
from scripts.lib.bandwidth.lib_bandwidth import bandwidth_builder, bandwidth_builder_attendance
