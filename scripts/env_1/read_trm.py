...
from scripts.lib.file import read_course_instances, read_start, read_config_from_canvas, read_course, read_environment, \
    read_secret_api_key
...
from scripts.model.environment.SecretApiKey import SECRET_API_KEY_FILE_NAME
