...
def publish_dashboard(instance_name):
    ...
    for file_name in file_names:
        ...
        # print(file_name)
    shutil.copytree(instance.get_student_path(), start.target_path + "students", copy_function=shutil.copy2,
                    ignore_dangling_symlinks=False,
                    dirs_exist_ok=True)
    shutil.copytree(instance.get_html_path(), start.target_path + "general", copy_function=shutil.copy2,
                    ignore_dangling_symlinks=False,
                    dirs_exist_ok=True)
