...
def publish_dashboard(instance_name):
    ...
    for file_name in file_names:
        ...
        # print(file_name)
    print("Target", start.target_path + instance.name + "//students")
    shutil.copytree(instance.get_student_path(), start.target_path + instance.name + "//students", copy_function=shutil.copy2,
                    ignore_dangling_symlinks=False,
                    dirs_exist_ok=True)
    print("Target", start.target_path + instance.name + "//general")
    shutil.copytree(instance.get_html_path(), start.target_path + instance.name + "//general", copy_function=shutil.copy2,
                    ignore_dangling_symlinks=False,
                    dirs_exist_ok=True)
