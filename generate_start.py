...
from lib.file import course_instance, project_path, start_file_name
...
start = Start(0, "Project Groups", "", "", get_date_time_obj("2023-09-03T00:00:00Z"), get_date_time_obj("2024-02-02T23:59:59Z"),
              ...
              project_path +"result_" + course_instance + ".json", project_path + "progress_" + course_instance + ".json", project_path + "attendance_report.csv",
              "", "grade", "progress")
